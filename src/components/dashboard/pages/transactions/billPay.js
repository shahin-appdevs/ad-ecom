    ...
    return (
        <div className="bg-white rounded-[12px] p-7">
            ...
            {isLoading ? (
                    ...
                    <table className="min-w-full divide-y divide-[#F5F7FF] whitespace-nowrap">
                        <thead>
                            <tr className="bg-[#F5F7FF] text-left text-sm text-color__paragraph">
                                ...
                                <th className="py-4 px-5 font-semibold">Bill Type</th>
                                <th className="py-4 px-5 font-semibold">Bill Month</th>
                                <th className="py-4 px-5 font-semibold">Bill Number</th>
                                <th className="py-4 px-5 font-semibold">Bill Amount</th>
                ...
                <div className="text-center py-5">No bill pay transactions found</div>
            ) : (
                <div className="table-wrapper overflow-x-auto">
                    <table className="min-w-full divide-y divide-[#F5F7FF] whitespace-nowrap">
                        <thead>
