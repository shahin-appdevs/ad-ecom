        ...
        <div className="bg-white rounded-[12px] p-7 max-w-2xl mx-auto">
            ...
            <div className="flex gap-3">
                <Link
                    ...
                    className="px-4 py-2.5 w-full text-center font-semibold bg-primary__color text-white rounded-md hover:bg-blue-600 transition"
                >
                    Create Another Link
                </Link>
                <Link
                    href={`/user/payment/link/edit?id=${link.id}`}
                    className="px-4 py-2.5 w-full text-center font-semibold bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition"
                >
                    Edit Link
                </Link>
            </div>
