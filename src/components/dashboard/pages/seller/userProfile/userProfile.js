...
import {
    profiledGetSellerAPI,
    profileUpdateSellerAPI,
    updatePasswordSellerAPI,
    kycGetSellerAPI,
    kycUpdateSellerAPI,
    ProfileDeleteSellerAPI,
...
export default function UserProfileSection() {
    ...
    const handlePasswordUpdate = async (e) => {
        ...
        setIsChanging(true);
        try {
            const response = await updatePasswordSellerAPI(
                currentPassword,
                newPassword,
    ...
    const onProfileDelete = async (e) => {
        ...
        try {
            ...
            const successMessage =
                response?.data?.message?.success || "Profile delete successful";
    ...
    const handleKycSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data && response.data.message.success) {
                toast.success(
                    "KYC submitted successfully! Status will update soon.",
                    { id: toastId },
                );
                setStatus("Pending");
                setFrontFile(null);
            ...
            if (err.response?.data?.message?.error) {
                ...
                toast.error("Please fix the errors in your submission", {
                    id: toastId,
                });
            } else {
                        ...
                        <form className="space-y-5" onSubmit={handleKycSubmit}>
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mb-3">
                                    Please upload clear images of both sides of
                                    your government-issued ID. Accepted formats:
                                    JPG, PNG, SVG, WEBP (max 10MB each).
                                </p>
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    <div className="mt-2">
                                        ...
                                        <p className="text-sm leading-[24px]">
                                            ...
                                            “JARA B2B” again and like your
                                            account deleted, we can take care of
                                            this for you. Keep in mind you will
                                            not be able to reactivate your
                                            account or retrieve any of the
                                            content or information you have
                                            added. If you would still like your
                                            account deleted, click “Delete
                                            Account”.?
                                        </p>
                                    </div>
