...
export default function ChildCategorySection() {
    ...
    return (
        <div className="bg-white rounded-[12px] p-7">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between pb-3 mb-2 gap-3 border-b-[1.5px] border-[#F5F7FF]">
                <h2 className="text-[16px] font-semibold">Child Category</h2>
                <div className="flex items-center gap-3">
                    <Link href="/seller/product/child-category/create" className="flex justify-center items-center gap-1 px-4 py-2 bg-primary__color text-white text-xs rounded-[8px] hover:bg-[#5851e3] transition">
                        ...
                        {filteredProducts.map((product, index) => (
                            <tr key={index}>
                                ...
                                <td className="py-3.5 px-5 whitespace-nowrap text-sm font-medium text-center gap-4">
                                    <Link href="/seller/product/child-category/details"><product.action className="h-5 w-5 text-gray-600 cursor-pointer" /></Link>
                                </td>
                            </tr>
                        ))}
                    </tbody>
