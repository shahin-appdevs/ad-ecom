...
import {
    productGetSellerAPI,
    productStatusUpdateSellerAPI,
    editProductSellerAPI,
...
export default function ProductSection() {
    ...
    const [filterOptions, setFilterOptions] = useState({
        ...
        subChildCategory: [
            { id: 3, name: "Select sub child category", value: "" },
        ],
            ...
            try {
                ...
                setFilterOptions((prev) => ({
                    ...
                    subChildCategory: [
                        ...
                        ...response.data.data.child_sub_categories.map(
                            (sub) => ({
                                id: sub.id,
                                name: sub.title,
                                value: sub.slug,
    ...
    const handleStatusUpdate = async (newStatus) => {
        try {
            ...
            const response = await productStatusUpdateSellerAPI(
                selectedProducts,
                statusValue,
            );
    ...
    const formatUpdateTime = (dateString) => {
        ...
        if (diffInDays === 0) dayText = "today";
            ...
            dayText = `${Math.floor(diffInDays / 7)} weeks ago`;
        else if (diffInDays < 365)
            dayText = `${Math.floor(diffInDays / 30)} months ago`;
            ...
            {loading ? (
                ...
                <div className="text-center py-5">
                    ...
                    {products.length === 0 && (
                        <Link
                            href="/seller/product/create"
                            className="text-primary__color hover:underline"
                        >
