...
export default function ChildSubCategorySection() {
    ...
    const handleStatusUpdate = (newStatus) => {
        ...
        if (selectedProducts.length > 0) {
            ...
            toast.success(
                `${selectedProducts.length} product(s) marked as ${newStatus}`,
            );
            setSelectedProducts([]);
        }
    };
        ...
        <div className="bg-white rounded-[12px] p-7">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between pb-3 mb-2 gap-3 border-b-[1.5px] border-[#F5F7FF]">
                ...
                <div className="flex items-center gap-3">
                    <Link
                        href="/seller/product/child-sub-category/create"
                        ...
                        {filteredProducts.map((product, index) => (
                            <tr key={index}>
                                ...
                                <td className="py-3.5 px-5 whitespace-nowrap text-sm font-medium text-center gap-4">
                                    <Link href="/seller/product/child-sub-category/details">
                                        <product.action className="h-5 w-5 text-gray-600 cursor-pointer" />
                                    </Link>
                                </td>
                            </tr>
                        ))}
