...
const categoryTypes = [
    { id: 1, name: "Panjabe Shop" },
    { id: 2, name: "Smart Gadgets" },
    { id: 3, name: "Computers" },
    { id: 4, name: "Electronic Device" },
    { id: 5, name: "Home & Kitchen" },
    { id: 6, name: "Real Estate" },
];

const childCategoryTypes = [
    { id: 1, name: "Laptops" },
    { id: 2, name: "Kitchen" },
    { id: 3, name: "Monitor" },
];
            ...
            <form className="pt-4 grid grid-cols-1 gap-4">
                <div className="grid grid-cols-12 gap-4">
                    ...
                    <div className="col-span-12 sm:col-span-12 md:col-span-6">
                        ...
                        <Listbox
                            value={selectedChildCategoryType}
                            onChange={setSelectedChildCategoryType}
                        >
                            <div className="relative">
                                <Listbox.Button className="w-full bg-white border border-gray-300 rounded-md py-2 px-3 text-sm text-left flex justify-between items-center">
                                    {selectedChildCategoryType.name}
                                    <ChevronUpDownIcon className="w-5 h-5 text-gray-400" />
                                </Listbox.Button>
                                <Listbox.Options className="absolute mt-1 w-full bg-white shadow-md rounded-md z-10">
