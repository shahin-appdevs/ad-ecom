    ...
    return (
        <section className="flex flex-col items-center justify-center min-h-[80vh] px-4">
            ...
            >
                ...
                <h1 className="text-2xl font-bold mb-3">Purchase Confirmed!</h1>
                <p className="text-center mb-6 max-w-md">
                    Thank you for your purchase. Your plan has been successfully
                    purchase and will be processed shortly.
                </p>
